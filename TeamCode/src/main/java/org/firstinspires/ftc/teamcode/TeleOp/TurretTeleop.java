...
@TeleOp(name = "Turret TeleOp PIDF Safe Speed", group = "TeleOp")
public class TurretTeleop extends LinearOpMode {
    ...
    double targetVelocity = 0.35 * MAX_RPM; // match old 0.7 power

    double servoPosition = 0.4;            // hood starting position
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Target RPM (0.7 power)", targetVelocity);
