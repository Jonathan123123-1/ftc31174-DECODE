...
@Autonomous(name = "9 Ball Auto - PedroPathing (Red - 1)", group = "Autonomous")
@Configurable
public class PedroPathingRed1 extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(110, 135, Math.toRadians(270)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            preLoadShot = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(111.000, 135.000),
            ...
            pickup1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(96.000, 84.000),
            ...
            shoot1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(124.000, 84.000),
                            new Pose(96.000, 84.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();
            ...
            grab1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(101.000, 60.000),
                            new Pose(129.000, 59.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();

            shoot2 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(129.000, 59.000),
                            new Pose(96.000, 84.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();
