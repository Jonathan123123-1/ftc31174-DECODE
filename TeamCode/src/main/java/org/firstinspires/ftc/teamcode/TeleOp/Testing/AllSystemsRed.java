...
@TeleOp(name = "TEST: All Systems Red", group = "TEST")
public class AllSystemsRed extends LinearOpMode {
    ...
    /* ================= SHOOTER CONSTANTS ================= */
    private static final double FAR_VELOCITY = 1525;   // 1570 RPM
    private static final double CLOSE_VELOCITY = 1200; // 1250 RPM
