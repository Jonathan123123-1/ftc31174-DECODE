...
@TeleOp(name = "Camera Turret Lock (Blue)", group = "Turret")
public class cameraLocalization extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (targetTag != null) {
                ...
                // We subtract because a positive yaw (tag is to the right) means we need to move the turret right.
                // If your motor direction is reversed, you may need to add this instead.
                ...
                telemetry.addLine("SEARCHING for Tag ID: " + BLUE_GOAL_TAG_ID);
            }
