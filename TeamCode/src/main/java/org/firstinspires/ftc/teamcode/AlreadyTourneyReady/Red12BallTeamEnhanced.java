...
@Autonomous(name = "100% RED - TEAM UP with EGG", group = "Autonomous")
@Configurable
public class Red12BallTeamEnhanced extends OpMode {
    ...
    private static final double STOPPER_OPEN_TIME = 1.4; // seconds
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            pickup1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(80.000, 74.000),
                                    new Pose(95.812, 25.940),
                                    new Pose(110.000, 37.000)
                            )
            ...
            pickup3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(80.000, 74.000),
                                    new Pose(84.338, 1.338),
                                    new Pose(120.50, 15.000)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
    ...
    public int autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1: // Shooting sequence - stopper and intake
                ...
                advanceAfter(2.5); // Total time for stopper + intake
                break;
