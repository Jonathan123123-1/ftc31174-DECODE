...
public class odometryTurretLocalization extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("Odometry Turret Lock Initialized - BLUE Alliance");
        telemetry.update();
    }
    ...
    private void handleTurretLogic() {
        ...
        switch (currentState) {
            case TRACKING:
                // THE FIX: Simplified to a direct angle calculation and clamp
                Pose robotPose = follower.getPose();
                double targetAngleRad = distanceLocalization.getTargetTurretAngle(robotPose, false);
