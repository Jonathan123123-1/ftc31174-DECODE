...
@TeleOp(name = "TeleOpTestCam", group = "Robot")
public class TeleOpTestCam extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("TeleOpTestCam Initialized");
        ...
        while (opModeIsActive()) {
            ...
            if (cameraActive) {
                ...
                if (targetTag != null && targetTag.ftcPose != null) {
                    ...
                    // -------------------------
                    // RIGHT TRIGGER → AUTO AIM STRAFE & ROTATION ONLY
                    // -------------------------
                    if (gamepad1.right_trigger > 0.05) {
                        ...
                        rotate = normalizedX * 0.2;

                        telemetry.addLine("AUTO AIM STRAFE ACTIVE");
                    }
                }
            }
